...
import { toggleCart, updateCartItem, removeCartItem } from '../store/activeSlices'
...
const CartPage = () => {
  const isOpen = true; // Always show the cart when accessing the /cart route directly
  ...
  const handleClose = () => {
    // Navigate back or to home when closing
    navigate(-1);
  };
        ...
        <div className="flex flex-col h-full">
          ...
          {cartItems.length === 0 ? (
            ...
            <>
              ...
              {/* Recommended Products - now showing from the same rank */}
              ...
              {recommendedProducts.length === 0 && cartItems.length > 0 && (
                <div className="p-4 border-t border-gray-700">
                  <h3 className="text-lg font-medium mb-3">YOU MIGHT ALSO LIKE</h3>
                  <div className="bg-gray-900 rounded shadow-md p-6 flex justify-center items-center">
